...
import { Search, Sparkles, Star, MapPin, Wrench, GraduationCap, Zap, Car, ChevronRight, Bell } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

const categories = [
  { icon: Wrench, label: "Plumber", color: "bg-blue-500/20 text-blue-400" },
  { icon: Zap, label: "Electrician", color: "bg-yellow-500/20 text-yellow-400" },
  { icon: GraduationCap, label: "Tutor", color: "bg-green-500/20 text-green-400" },
  { icon: Car, label: "Mechanic", color: "bg-orange-500/20 text-orange-400" },
]
      ...
      <div className="mobile-section">
        ...
        <div className="space-y-3">
          {topServices.map((service) => (
            <Link key={service.id} href={`/mobile/service/${service.id}`}>
